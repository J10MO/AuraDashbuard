  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      >
        {/* Sidebar Header */}
        <div className="flex h-16 flex-shrink-0 items-center justify-between border-b border-border px-4 md:px-6">
          {sidebarOpen && <h1 className="truncate text-xl font-bold text-foreground">Admin</h1>}
          <Button
            variant="ghost"
            size="icon"
            onClick={toggleSidebar}
        ...
        {sidebarOpen && user && !isMobile && (
          <div className="flex-shrink-0 border-t border-border p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-foreground">{user.name || user.phone || "User"}</p>
                <p className="truncate text-xs capitalize text-muted-foreground">{user.role || "user"}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 flex-shrink-0 items-center justify-between border-b border-border bg-card px-4 md:px-6">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="truncate text-sm font-semibold text-foreground">{user.name || user.phone || "User"}</h2>
              <p className="truncate text-xs text-muted-foreground">{user.role || "Administrator"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Button variant="outline" size="sm" onClick={handleLogout} className="h-9 gap-2 bg-transparent">
              <LogOut className="h-4 w-4" />
              <span className="hidden sm:inline text-sm">Logout</span>
            </Button>
          </div>
